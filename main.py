...
def genereaza_conductor(x):
    ...
    # urmatoarele 3 cifre reprezinta seria, pentru a diferentia copiii nascuti in acelasi loc, in acelasi an, in aceeasi luna si in aceeasi zi
    # ultima cifra reprezinta cifra de control
